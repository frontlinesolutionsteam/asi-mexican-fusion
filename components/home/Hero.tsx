        ...
        <div className="max-w-2xl">
          ...
          <Reveal immediate delay={0.24}>
            <div className="mt-9 flex flex-wrap items-center gap-4">
              ...
              <ButtonLink
                href="https://www.doordash.com/store/asi-mexican-fusion-bistro-san-jose-28377796/37461549/?event_type=autocomplete&pickup=false"
                size="lg"
                variant="outline"
              >
                Delivery
